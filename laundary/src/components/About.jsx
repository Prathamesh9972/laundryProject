        ...
        <div className="about-testimonials-section">
          ...
          <div className="about-testimonial">
            <p className="about-testimonial-text">
              "Fantastic service! My clothes have never looked better. Highly recommend!"
            </p>
            <p className="about-testimonial-author">- Anurag</p>
          </div>
          <div className="about-testimonial">
            <p className="about-testimonial-text">
              "Convenient and reliable. The team is always friendly and helpful."
            </p>
            <p className="about-testimonial-author">- Manthan</p>
          </div>
